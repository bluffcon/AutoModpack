...
public class FingerprintVerificationScreen extends VersionedScreen {
    ...
    public void initWidgets() {
        ...
        // Verify button (middle - primary action, bold, in the middle because thats where your eyes go first)
        ...
        // Back button (right, like every other minecraft button)
